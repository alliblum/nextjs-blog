        ...
        <Center>
          ...
          >
            ...
            <Stack mt={10} spacing={5}>
              ...
              <Text>
                This is the story of how I learned that getting* customer
                insights out of a JTBD research project and mobilizing* insights
                across the org are two completely different initiatives. A few
                years ago I ran a JTBD study, identified the job stories, &
              ...
              <Text>
                And then... nothing happened. After that project presentation,
                few people consulted the recordings, the transcripts, or the
              ...
              <UnorderedList>
                <ListItem>
                  Replacing much of what was on the roadmap with new
                  opportunities
                </ListItem>
                <ListItem>
                  {' '}
              ...
              <Text>
                None of this happened and little changed because saying, "Here's
                a report, now go do stuff," won't get an entire org to build a
              ...
              <Text>
                Using insights to build a customer-led culture doesn't happen
                with research alone - it happens by re-orienting away from
                mobilizing *the insights* and instead mobilizing *the team* to
                believe in and use the insights as a guiding strategy for
                decision-making. And that is a change strategy project
