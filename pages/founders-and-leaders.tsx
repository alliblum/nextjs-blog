  ...
  return (
    <Layout home>
      <Stack spacing={5}>
        ...
        <Heading size="xl">And yet, here you are.</Heading>
        <Text>
          Spending the most productive and creative hours of your day responding
          to questions you thought you answered a thousand times over.
        </Text>
        <Text>
          Listening to your team spin their wheels, brainstorm ideas, and add
          more ideas to an ever-growing backlog - and wondering why it’s taking
          so long to ship work that increases your acquisition, activation, and
          retention numbers.{' '}
        </Text>
        <Text>
        ...
        <Text>
          This fixed scope quarter-long project is about finding what’s most
          likely to grow your business now, getting your team to see and believe
          that vision, and giving them the building blocks to start shipping
          2-3X faster at one bajillionX the quality.{' '}
        </Text>
        <Text>In this project we’ll:</Text>
        <UnorderedList spacing={3}>
          {' '}
          <ListItem>
            <Text as="strong">Find out what matters most now:</Text> Agree on
            who your best customers are, surface the jobs they desperately want
            to hire your project for, and find out when they are most likely to
            be shopping for your solution with a Roadmapping Session and Jobs To
            Be Done research study.{' '}
          </ListItem>
          <ListItem>
            <Text as="strong">Mobilize your vision:</Text> Get your team to see
            your vision through eyes so they trust and believe in the vision you
            see with yours by turning the raw voice-of-customer data we uncover
        ...
        <UnorderedList spacing={3}>
          ...
          <ListItem>
            ...
            of your leadership team, I’ll do the above plus find and fix the
            challenges and blockers that are stopping your team from making
            autonomous, evidence-backed, outcome-generating decisions that scale
            your business.{' '}
          </ListItem>
          <ListItem>
            ...
            onboarding emails, and updated copy.{' '}
          </ListItem>
        </UnorderedList>
        <Text>
        ...
        <Heading size="lg">
          ...
          but keeps your business stagnant{' '}
        </Heading>
        <Text> Here’s what I want for you:</Text>
        <UnorderedList spacing={3}>
          <ListItem>
          ...
          <ListItem>
            <Text as="strong">Get back to business: </Text>Reclaim your focus
        ...
        <UnorderedList spacing={3}>
          {' '}
          <ListItem>
            Helped a company launch a new product for a new market and coached
            the team to grow it 0-1, from development to launch to established
            and integral asset
          </ListItem>
          <ListItem>
            {' '}
            Led change management initiative to coach a team of 10 to transition
            from working as a marketing team to establish operational readiness
            as a product team{' '}
          </ListItem>
          <ListItem>
            Designed in-app and email onboarding experiences that increased new
            customer activation by 144%-300%{' '}
          </ListItem>
          <ListItem>
            Introduced leadership, decision-making, and operational readiness
            coaching and frameworks to sustain growth in the wake of change
          </ListItem>
          <ListItem>
            {' '}
            Trained team members on conversion copywriting, JTBD research, UX
            design, product strategy, and leadership to increase product release
            cycle output for team{' '}
          </ListItem>
          <ListItem>
            Identified core JTBD to inform product, marketing, and overall
            company strategy{' '}
          </ListItem>
          <ListItem>
            Worked with over 50 teams to launched Voice of Customer programs to
            unite strategy and decision-making across sales, product, and
        ...
        <UnorderedList>
          ...
          <ListItem>Qualitative and user research </ListItem>
          <ListItem>UX design </ListItem>
          <ListItem>Product </ListItem>
          <ListItem>Marketing</ListItem>
          <ListItem>Conversion copywriting </ListItem>
          <ListItem>Segment event protocols </ListItem>
          <ListItem>Positioning </ListItem>
        ...
        <UnorderedList>
          ...
          <ListItem> LTVConf</ListItem>
          <ListItem> UIBreakfast </ListItem>
